...
//    var stripePublishableKey = "pk_test_51H7kEVGsV27pOa0Ot4JccQx1EEN39C4yg1wgtVxbh3ixZUSvmx8glp0kccsQSID5I1XCvE14ZLe4XYNHtviXd3vf00pVICEpCv"
...
//    var backendBaseURL: String? = "https://groopcamios.herokuapp.com/"
    ...
    var appleMerchantID: String? = "merchant.groopcam"

    // These values will be shown to the user when they purchase with Apple Pay.
    let companyName = "GroopCam"
...
""")
    ...
    override func viewDidLoad() {
        ...
        self.activityIndicator.alpha = 0
        self.buyButton.addTarget(self, action: #selector(didTapConfirm), for: .touchUpInside)
